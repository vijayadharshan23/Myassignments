...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		WebElement element12=driver.findElement(By.linkText("Duplicate Lead"));
		element12.click();
		WebElement element13 = driver.findElement(By.id("createLeadForm_companyName"));
		element13.clear();
		element13.sendKeys("SpaceX");
		WebElement element14 = driver.findElement(By.id("createLeadForm_firstName"));
		element14.clear();
		element14.sendKeys("Bat");
		WebElement element15 = driver.findElement(By.id("createLeadForm_generalStateProvinceGeoId"));
		Select dd1= new Select (element15);
		dd1.selectByVisibleText("New York");
		WebElement elementcreate1=driver.findElement(By.className("smallSubmit"));
		elementcreate1.click();
		if(driver.getTitle().contains("View Lead")) {
			System.out.println("I confirm that the title has View Lead");
		}
		else {
